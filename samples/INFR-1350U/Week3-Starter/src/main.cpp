...
void GlfwWindowResizedCallback(GLFWwindow* window, int width, int height) { glViewport(0, 0, width, height); }
...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Ryan Chang - 100745877", nullptr, nullptr);
...
int main() {
	...
	*/
	...
	//     X     Y     Z     R     G     B
		 ...
		 0.7f, 0.5f, 0.5f, 0.3f, 0.2f, 0.5f,
		-0.2f, 0.5f, 0.5f, 1.0f, 1.0f, 0.0f,
		 0.7f, -0.5f, 0.5f, 1.0f, 1.0f, 1.0f
	};
